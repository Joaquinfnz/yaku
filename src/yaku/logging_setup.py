...
Extraido de run_pipeline.setup_logging. Un unico logger "yaku" con salida a
...
def setup_logging(log_dir: Path, *, name: str = "yaku") -> logging.Logger:
    ...
    log_file = log_dir / f"yaku_{datetime.now():%Y%m%d_%H%M%S}.log"
