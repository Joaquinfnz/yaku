"""Terminal guiada de mfworkflow (`mfw tui`).
...
- No reimplementa logica: cada accion construye un `argparse.Namespace` y llama al
  `cmd_*` correspondiente de `mfworkflow.cli`, asi la TUI y la CLI nunca divergen.
"""
...
def _seleccionar_proyecto(ui: UI, inicial: str | None) -> str | None:
    from mfworkflow.cli import _listar_proyectos
