...
try:
    ...
    from mfworkflow.report import tema
...
def write_pdf(
    ...
    *,
    ...
    output_path.parent.mkdir(parents=True, exist_ok=True)
    with tempfile.TemporaryDirectory(prefix="mfworkflow_report_") as temp_dir:
...
def generar_informe(cfg, output_path: Path, perfil: str = "astm", formato: str = "pdf") -> Path:
    ...
    return write_pdf(
        ...
        autor=cfg.proyecto.get("autor", "mfworkflow"),
        perfil=perfil,
        resultados=res,
