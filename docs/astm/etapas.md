...
| 4 | Calibración (D5981) | `yaku calibrate` | RMSE/MAE, scatter obs-sim, parámetros | Cap. 4 |
| 5 | Sensibilidad | `yaku calibrate --setup-pest` | ranking de parámetros | Cap. 5 |
| 6 | Predicción + incertidumbre | `yaku calibrate --run --engine pestpp-ies` | escenarios, bandas de incertidumbre | Cap. 6 |
